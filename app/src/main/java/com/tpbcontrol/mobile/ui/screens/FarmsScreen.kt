...
fun FarmsScreen(
    ...
    when {
        ...
        state.items.isEmpty() -> EmptyState(message = "Nenhuma fazenda encontrada.")
            ...
            items(state.items, key = { it.id }) { farm ->
                FarmCard(farm = farm)
            }
        }
    }
